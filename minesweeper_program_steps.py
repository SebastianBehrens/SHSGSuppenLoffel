...
1.4 Create a list with the positions of the bombs [row][column]
...
1.6 Create an "empty_grid" which is available to the user with the same dimnesions (using '-')
...
3.4 Scorekeeper
3.5 Give the user 3 options (Easy, Middle and Hard)
